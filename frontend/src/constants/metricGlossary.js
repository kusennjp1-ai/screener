...
const GLOSSARY = {
  ...
  pressure_state: {
    ...
    meaning: 'MM360の3色バンドの1本目。機関投資家の累積的な買い集め/売り抜け（Force Index系）を検出します。',
    reading: '緑=買い集め進行中、黄=中立、赤=売り抜け。緑の期間のみ新規買いが安全とされます。',
  },
  buy_risk_state: {
    title: 'Buy Risk（買いリスクバンド）',
    meaning: 'MM360の3色バンドの2本目。今この価格で買った場合のリスク量（50日線からのATR乖離ベースの過熱度）です。',
    reading: '緑=低リスク（買って良い位置）、黄=中、赤=過熱（ここからの新規買いは不利）。',
  },
  tpr_state: {
    title: 'TPR（トレンド適合度バンド）',
    meaning: 'MM360の3色バンドの3本目。ミネルヴィニのトレンドテンプレート7条件への適合度です。',
    reading: '緑=Stage 2の上昇トレンド（買い候補圏）、黄=移行中、赤=トレンド不成立。',
  },
  daily_score: {
    title: 'スコア',
