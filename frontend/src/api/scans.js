 ...
 * @param {string} [params.universe_def.market] - Market code: 'US', 'HK', 'IN', 'JP', 'KR', 'TW', 'CN', 'CA', 'DE', 'SG', 'MY' (if type='market', optional for type='exchange')
 * @param {string} [params.universe_def.exchange] - Exchange name: 'NYSE', 'NASDAQ', 'AMEX', 'KOSPI', 'KOSDAQ', 'SSE', 'SZSE', 'BJSE', 'TSX', 'TSXV', 'XETR', 'XFRA', 'XSES', 'XKLS' (if type='exchange')
 ...
 * @param {string} params.market - Market code: US, HK, IN, JP, KR, TW, or CN
