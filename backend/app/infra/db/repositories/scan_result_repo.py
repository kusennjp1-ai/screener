...
def _map_row_to_domain(
    ...
    *,
    ...
    # MM360 band states (kept in parity with the feature-store mapping)
    extended["pressure_state"] = details.get("pressure_state")
    extended["pressure_value"] = details.get("pressure_value")
    extended["buy_risk_state"] = details.get("buy_risk_state")
    extended["buy_risk_atr"] = details.get("buy_risk_atr")
