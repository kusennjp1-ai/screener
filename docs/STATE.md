...
- **サイクル**: C61 完了（progressive risk採用: 6y +112.4%/Sharpe0.92、10y +97.8%/Sharpe0.53——両窓一貫改善・DD不変）／ **次: C62=分配日失効/リセットのIBD照合（market_regime.py本体＝GATE凍結metric・908ハーネス必須。2019/2021の過剰防御が最後の本命課題）**
